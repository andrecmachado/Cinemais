...
public class CSF3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_csf3);
        tv = (ListView) findViewById(R.id.ListViewCS3);
    ...
    public void favoritar (View v) {
        Toast.makeText(CSF3Activity.this, "Adicionado aos favoritos", Toast.LENGTH_LONG).show();
    }
